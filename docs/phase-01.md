...
6. Keep the coding rules in `docs/agent-skills/llm-coding-style.md` and `docs/agent-skills/bruno-testing.md` aligned with the phase.
...
- [Spring Boot MVC coding style and core business reminders](./agent-skills/llm-coding-style.md)
