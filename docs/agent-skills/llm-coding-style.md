# Spring Boot MVC coding style and core business system reminders

## Purpose

Keep code that an agent writes small, readable, and easy to verify.

This repo is a Spring Boot MVC banking application. The controller layer is only the delivery shell; the wallet and money-movement rules are the core business system and must stay explicit in the code.
